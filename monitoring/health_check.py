...
class HealthMonitor:
    def __init__(self):
        ...
        self.thresholds = [
            ...
            AlertThreshold(
                "trade_success_rate", 50.0, "warning", "Low trade success rate"
            ),
            AlertThreshold(
                "trade_success_rate", 30.0, "critical", "Critical trade success rate"
            ),
        ]
    ...
    async def send_discord_alert(self, alert: str):
        ...
        try:
            embed = {
                ...
                "footer": {"text": "Elite Alpha Mirror Bot Monitoring"},
            }
    ...
    async def generate_health_report(self) -> Dict:
        ...
        if recent_metrics:
            ...
            avg_success_rate = sum(m.trade_success_rate for m in recent_metrics) / len(
                recent_metrics
            )
        else:
        ...
        return {
            ...
            "trading": {
                ...
                "last_trade": latest.last_trade_time.isoformat()
                if latest.last_trade_time
                else None,
            },
        ...
        while True:
            try:
                ...
                if len(self.metrics_history) % 10 == 0:  # Every 10 minutes
                    ...
                    logging.info(
                        f"📊 Health Status: {report['status']} | CPU: {metrics.cpu_percent:.1f}% | Memory: {metrics.memory_percent:.1f}% | Portfolio: ${metrics.portfolio_value:.2f}"
                    )
